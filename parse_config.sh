...
#kernel.server.tomcat.https.ef.hostname = $(hostname -s)
...
# OAuth2 Server URL
dcvsm.oauth2.url = https\://$(hostname)\:8446/oauth2/token
...
dcvsm.broker.url = https\://$(hostname)\:8446
